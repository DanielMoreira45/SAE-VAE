...
public class FenetreCreationCompte extends GridPane {
    ...
    public void ajouteTextField() {
        ...
        this.erreurEmailMsg.setFont(Font.font("Varela", FontWeight.THIN, 10));
        this.erreurEmailMsg.setFill(Color.RED);
        this.mdp.setPromptText("Entrez le mot de passe");
        this.mdp.setTooltip(new Tooltip(
        ...
        this.add(this.erreurEmailMsg, 50, 29);
    ...
    public void setMdpConfimationErreur(boolean hasErreur) {
        if (hasErreur)
            this.mdpConfirme.setStyle("-fx-border-color: red");
        else
            this.mdpConfirme.setStyle("-fx-border-color: #a3a3a3aa");
    }
    ...
    public void setEmailErreur(String msg) {
        this.erreurEmailMsg.setText(msg);
    }

    public void setEmailMessageErreur(boolean hasErreur) {
        if (hasErreur)
            this.mail.setStyle("-fx-border-color: red");
        else
            this.mail.setStyle("-fx-border-color: #a3a3a3aa");
    }
}